                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-12 d-grid mt-3">
                                        <button class="btn btn-primary btn-lg fw-semibold d-flex align-items-center justify-content-center" type="submit" id="submitBtn">
                                            ...
                                            <i class="bi bi-search me-2" id="submitIcon"></i> Verify Phone
                                        </button>
                                    </div>
                                </div>
                            </form>
                        ...
                        <div class="card-body">
                            @if (session('verification'))
                                ...
                                <div class="d-flex flex-wrap justify-content-center gap-2">
                                    <button onclick="confirmDownload('{{ route('nin.phone.regularSlip', $verificationData['nin']) }}', 'Regular Slip', {{ $regularSlipPrice ?? 0 }})" 
                                    ...
                                    <button onclick="confirmDownload('{{ route('nin.phone.standardSlip', $verificationData['nin']) }}', 'Standard Slip', {{ $standardSlipPrice ?? 0 }})" 
                                    ...
                                    <button onclick="confirmDownload('{{ route('nin.phone.premiumSlip', $verificationData['nin']) }}', 'Premium Slip', {{ $premiumSlipPrice ?? 0 }})" 
