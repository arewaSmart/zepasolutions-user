...
class AgencyController extends Controller
{
    ...
    public function bvnModRequest(Request $request)
    {
        ...
        $request->validate([
            ...
            'enrollment_center' => [
                'required',
                'string',
                'in:First Bank,Heritage Bank,Agency Banking,Taj Bank,GTbank,FCMB,Zenith Bank,Access Bank,Keystone Bank',
            ],
    ...
    public function ipeRequestStatus($trackingId, $transactionId)
    {
        try {
